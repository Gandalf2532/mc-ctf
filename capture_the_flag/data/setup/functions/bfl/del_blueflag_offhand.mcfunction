...
execute as @e[type=armor_stand,tag=pointblue] at @s run execute as @a[distance=..4,team=blueTeam] run item replace entity @a[distance=..4,team=blueTeam] weapon.offhand with air
